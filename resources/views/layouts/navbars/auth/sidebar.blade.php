<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-left ms-3"
    ...
    <div class="sidenav-header">
        ...
        <a class="navbar-brand m-0" href="{{ route('dashboard') }}">
            ...
            <span class="ms-1 font-weight-bold">Paraxute</span>
        </a>
    </div>
    ...
    <div class="collapse navbar-collapse w-auto" id="sidenav-collapse-main">
        <ul class="navbar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link {{ Route::currentRouteName() == 'tables' ? 'active' : '' }} {{ Route::currentRouteName() == 'recibos.create' ? 'active' : '' }}"
                    href="{{ route('tables') }}">
                    <div
                        class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
    ...
    <div class="sidenav-footer mx-3 mt-3 pt-3">
        <div class="card card-background shadow-none card-background-mask-secondary" id="sidenavCard">
            <div class="full-background" style="background-image: url('../assets/img/curved-images/yipistudiosjpg')">
            </div>
            <div class="card-body text-left p-3 w-100">
                <div class="docs-info">
                    <h6 class="text-center text-white up mb-2">¿Necesitas ayuda?</h6>
                    <a href="https://twitter.com/StudiosYipi" target="_blank"
                        class="btn btn-white btn-sm w-100 mb-0">Contáctanos</a>
                </div>
            </div>
        </div>
    </div>
